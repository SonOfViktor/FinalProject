...
public final class PagePath {
    ...
    public static final String APPROVE_TATTOO_PAGE_REDIRECT = "/ProjectServlet?command=to_approve_tattoo_page";
    ...
    public static final String FIND_ORDER_BY_ID_REDIRECT = "/ProjectServlet?command=to_find_order_by_id_page";
    public static final String FIND_ORDER_BY_LOGIN_REDIRECT = "/ProjectServlet?command=to_find_order_by_login_page";
    public static final String FIND_ORDER_BY_STATUS_REDIRECT = "/ProjectServlet?command=to_find_order_by_status_page";
    public static final String FIND_TATTOO_BY_ID_REDIRECT = "/ProjectServlet?command=to_find_tattoo_by_id_page";
    public static final String FIND_TATTOO_BY_NAME_REDIRECT = "/ProjectServlet?command=to_find_tattoo_by_name_page";
    public static final String FIND_TATTOO_BY_PLACE_REDIRECT = "/ProjectServlet?command=to_find_tattoo_by_place_page";
    public static final String FIND_TATTOO_BY_PRICE_RANGE_REDIRECT = "/ProjectServlet?command=to_find_tattoo_by_price_range_page";
    public static final String FIND_USER_BY_ID_REDIRECT = "/ProjectServlet?command=to_find_user_by_id_page";
    public static final String FIND_USER_BY_LOGIN_REDIRECT = "/ProjectServlet?command=to_find_user_by_login_page";
    public static final String FIND_USER_BY_NAME_REDIRECT = "/ProjectServlet?command=to_find_user_by_name_page";
    public static final String FIND_USER_BY_SURNAME_REDIRECT = "/ProjectServlet?command=to_find_user_by_surname_page";
    ...
    public static final String CHANGE_PAGE_RATING_REDIRECT = "/ProjectServlet?command=to_change_rating";
