...
public final class ColumnName {
    ...
    public static final String TATTOOS_PRICE ="price";
    public static final String TATTOOS_WIDTH ="width";
    public static final String TATTOOS_HEIGHT ="height";
    public static final String TATTOOS_IMAGE_URL ="image_url";
