...
public class ChangeRoleCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        try {
            ...
            parameters.put(ColumnName.USER_ROLE, request.getParameter(RequestParameter.USER_ROLE));
            userService.updateRole(parameters, userId);
            ...
            switch (user.getRole()) {
                ...
                default -> {
                    logger.error("Error after change role with a return to the profile page.");
