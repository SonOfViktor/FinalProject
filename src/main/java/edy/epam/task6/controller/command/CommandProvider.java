...
import edy.epam.task6.controller.command.impl.*;
import edy.epam.task6.controller.command.impl.change.*;
import edy.epam.task6.controller.command.impl.find.*;
import edy.epam.task6.controller.command.impl.page.*;
