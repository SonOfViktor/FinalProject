...
<div class="container-register">
    ...
    <form method="post" action="ProjectServlet">
        <input type="hidden" name="command" value="register_person"/>
        <div class="info-div">
            <input type="text" name="name" placeholder="<fmt:message key="register.placeholder.name"/>"
                   required
        ...
        <div class="info-div">
            <input type="text" name="surname" placeholder="<fmt:message key="register.placeholder.surname"/>"
                   required
